...
# Run interval: 12 hours (720 minutes)
    ...
    def get_runtime_stats(self):
        ...
        if self.last_execution_time:
            ...
            if time_until_next.total_seconds() > 0:
                hours_left, remainder = divmod(time_until_next.total_seconds(), 3600)
                mins, secs = divmod(remainder, 60)
                next_run_str = f"{int(hours_left)}h {int(mins)}m {int(secs)}s"
            else:
                next_run_str = "Now"
        else:
...
def main():
    ...
    try:
        ...
        print(f"{'12-Hour Interval Version':^70}")
        print("🚀" * 35)
        print(f"\n  ⏰ Schedule: Every 12 hours (720 minutes)")
        ...
        print(f"✅ Scheduler configured (12-hour interval)\n")
        ...
        print(f"   Next execution in 12 hours")
        print("═" * 70 + "\n")
